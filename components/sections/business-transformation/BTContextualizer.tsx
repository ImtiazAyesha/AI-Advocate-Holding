    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(136, 201, 179, 0.12) 0%, transparent 60%)",
            filter: "blur(60px)",
          }}
        />
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(26, 36, 33, 0.04) 0%, transparent 60%)",
            filter: "blur(60px)",
          }}
        />
      </div>
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-12 lg:gap-24 items-center">
          ...
          <div className="flex flex-col">
            ...
            >
              ...
              <span className="relative inline-block">
                <span className="heading-highlight">Digital Product</span>
              </span>{" "}
              Studio.
            </motion.h2>
          ...
          >
            <div className="relative w-full max-w-[440px] aspect-square overflow-hidden rounded-[32px] border border-white/20 shadow-[0_30px_60px_-15px_rgba(26,36,33,0.4)] transition-transform duration-500 hover:-translate-y-2 group">
