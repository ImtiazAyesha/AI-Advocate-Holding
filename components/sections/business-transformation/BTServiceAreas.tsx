...
function ServiceCard({
  ...
  const themeClasses = isDark
    ? "bg-evren-navy border border-evren-navy-light/30 shadow-[0_20px_60px_rgba(26,36,33,0.1)] hover:shadow-[0_20px_60px_rgba(26,36,33,0.2)]"
    : isPeach
    ? "bg-gradient-to-br from-[#E8F4F0] to-white border border-evren-peach/20 hover:border-evren-peach/40 hover:shadow-[0_20px_40px_rgba(136,201,179,0.15)]"
    : "bg-white border border-evren-light-gray/60 hover:border-evren-peach/30 hover:shadow-[0_20px_40px_rgba(26,36,33,0.06)]";
