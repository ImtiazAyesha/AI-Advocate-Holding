    ...
    >
      <div className="max-w-[1024px] mx-auto">
        ...
        >
          ...
          <h2 className="font-heading text-[36px] md:text-[48px] lg:text-[52px] font-extrabold text-evren-navy leading-[1.1] tracking-tight max-w-[800px] mx-auto mb-6">
            ...
            <span className="relative inline-block">
              <span className="heading-highlight">Starting Points.</span>
            </span>
          </h2>
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-2 rounded-[24px] border border-evren-light-gray overflow-hidden shadow-[0_20px_40px_rgba(26,36,33,0.04)] mb-14"
        >
          {/* LEFT: Start Here */}
