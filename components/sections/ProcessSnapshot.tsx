  ...
  return (
    <motion.button
      ...
      className={`w-full h-full text-left group relative flex items-center gap-4 lg:gap-6 px-4 py-3 sm:px-5 sm:py-4 lg:px-6 lg:py-8
                  ...
                  ${isActive
          ? "bg-white border-evren-peach/30 shadow-[0_4px_16px_rgba(136,201,179,0.12)]"
    ...
    >
      ...
      <motion.div
        className={`relative flex-shrink-0 w-10 h-10 lg:w-14 lg:h-14 rounded-full flex items-center justify-center
                    ...
                    ${isActive ? "bg-evren-peach shadow-[0_4px_12px_rgba(136,201,179,0.3)]" : "bg-white border border-evren-navy/5"}`}
