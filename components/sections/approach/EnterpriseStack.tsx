  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(26, 36, 33, 0.05) 0%, transparent 70%)",
          filter: "blur(100px)",
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            The <span className="heading-highlight">Production</span> Stack
          </motion.h2>
          ...
          {/* <motion.div
            ...
            style={{
              background:
                "linear-gradient(90deg, rgba(136, 201, 179, 0.7), rgba(107, 168, 142, 0.3))",
            }}
          /> */}
  ...
  return (
    <div
      className={`group relative rounded-2xl p-6 border border-solid ${layer.borderColor} ${layer.bgColor}
                  ...
                  hover:border-evren-peach hover:shadow-[0_20px_40px_-12px_rgba(26,36,33,0.15)] overflow-hidden cursor-default`}
    >
