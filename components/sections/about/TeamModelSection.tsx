    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(136, 201, 179, 0.14) 0%, rgba(136, 201, 179, 0.03) 50%, transparent 70%)",
            filter: "blur(45px)",
          }}
        />
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(78, 124, 110, 0.10) 0%, rgba(78, 124, 110, 0.02) 50%, transparent 70%)",
            filter: "blur(40px)",
          }}
        />
      </div>
      ...
      <div
        ...
        style={{
          ...
          backgroundImage:
            "linear-gradient(to right, rgba(26, 36, 33, 0.02) 1px, transparent 1px), linear-gradient(to bottom, rgba(26, 36, 33, 0.02) 1px, transparent 1px)",
          maskImage:
          ...
          >
            ...
            <motion.div
              ...
              className="sm:col-span-2 group relative overflow-hidden
                         ...
                         shadow-[0_20px_60px_rgba(26,36,33,0.1)] hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(26,36,33,0.2)]"
            >
            ...
            <motion.div
              variants={cardPop}
              className="group relative overflow-hidden
                         bg-gradient-to-br from-[#E8F4F0] to-white border border-evren-peach/20
                         rounded-[24px] p-7 lg:p-8 cursor-pointer
                         transition-all duration-300 ease-out
                         shadow-none hover:shadow-[0_20px_40px_rgba(136,201,179,0.15)] hover:border-evren-peach/30 hover:-translate-y-1"
            >
              {/* Subtle background icon */}
