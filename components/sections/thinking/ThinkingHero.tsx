...
import { Network, BrainCircuit, Terminal, Cpu } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div className="absolute inset-y-0 left-1/2 -translate-x-1/2 w-full max-w-[1060px] z-0 pointer-events-none hidden lg:block">
