...
function ArticleCard({
  ...
  return (
    ...
    >
      ...
      >
        {/* ── Image Section — match hero 1200×628 aspect ratio to avoid crop + upscale blur ── */}
        <div className="relative w-full aspect-[1200/628] bg-[#F2F2F2] overflow-hidden flex-shrink-0">
        ...
        <div className="p-6 flex flex-col flex-1">
          ...
          <div className="flex items-center gap-4 mb-4">
            <span className="text-xs font-bold tracking-wider text-[#88C9B3] uppercase font-body">
              {primaryCategory}
            </span>
...
export default function ArticleGrid({ initialPosts }: { initialPosts: BlogPost[] }) {
