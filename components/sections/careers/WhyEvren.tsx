        ...
        >
          ...
          <h2 className="font-heading text-[32px] md:text-[40px] lg:text-[48px] font-semibold text-evren-navy leading-[1.2] tracking-tight max-w-[800px] mx-auto">
            ...
            <span className="relative inline-block">
              <span className="heading-highlight">Matter.</span>
            </span>
          </h2>
        ...
        <div className="mt-[48px] lg:mt-[64px] grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-[24px]">
          {CARDS.map((card, idx) => (
            <motion.div
              ...
              className={`group bg-white border border-evren-light-gray rounded-[24px] p-[16px] flex flex-col transition-all duration-300 hover:shadow-[0_12px_32px_rgba(26,36,33,0.06)] hover:-translate-y-1 ${
