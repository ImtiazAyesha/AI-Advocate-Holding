    ...
    >
      <div className="max-w-[1024px] mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="font-heading text-[32px] md:text-[40px] lg:text-[48px] font-semibold text-evren-navy leading-[1.2] tracking-tight max-w-[800px] mx-auto">
            ...
            <span className="relative inline-block">
              <span className="heading-highlight">Expect.</span>
            </span>
          </h2>
        ...
        <motion.div
          ...
          className="w-full flex flex-col bg-white rounded-[32px] shadow-[0_8px_40px_rgba(26,36,33,0.04)] border border-evren-light-gray overflow-hidden [-webkit-tap-highlight-color:transparent] relative"
        >
          ...
          <div className="relative w-full min-h-[380px] sm:min-h-[300px] md:min-h-[280px] px-[32px] pt-[32px] pb-[96px] md:p-[48px] lg:p-[64px] flex items-center bg-[radial-gradient(circle_at_top_right,rgba(136,201,179,0.05)_0%,transparent_50%)]">
              ...
              <button
                ...
                className={`w-[44px] h-[44px] md:w-[48px] md:h-[48px] rounded-full flex items-center justify-center transition-all duration-300 border focus:outline-none focus:ring-0 [-webkit-tap-highlight-color:transparent] ${
                  activeStep === 0
                    ...
                    : "bg-white border-evren-light-gray text-evren-navy hover:border-evren-peach hover:text-evren-peach hover:shadow-[0_4px_16px_rgba(136,201,179,0.15)] hover:-translate-y-0.5 active:translate-y-0"
                }`}
