...
export const ARTICLES: Article[] = [
  {
    ...
    readTime: "7 min read",
    body: [
      "Every AI Advocate engagement begins the same way: three weeks of discovery before a single model is trained or a single pipeline is built. We call it the Data Topology Audit, and it's the highest-leverage investment we make on behalf of our clients.",
  ...
  },
  {
    ...
    body: [
      ...
      "At AI Advocate, we've developed a framework for ethical dynamic pricing that we apply to every commerce engagement. It rests on three principles: transparency, fairness, and auditability.",
