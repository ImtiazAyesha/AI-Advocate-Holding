    ...
    <DeferredSmoothScroll>
      ...
      <main className="flex flex-col min-h-screen bg-evren-warm-white pb-[80px] md:pb-[120px]">
        ...
        <div className="pt-[140px] md:pt-[180px] pb-[40px] md:pb-[60px] px-5 sm:px-6 relative overflow-hidden border-b border-evren-light-gray">
          ...
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[radial-gradient(circle,rgba(136,201,179,0.15)_0%,transparent_60%)] rounded-full blur-3xl pointer-events-none -mr-40 -mt-40 z-0" />
        ...
        <div className="px-5 sm:px-6 mt-[64px] md:mt-[80px]">
          <div className="max-w-[1024px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-[64px] lg:gap-[80px]">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-[10px]">
                  {job.bonuses.map((bonus, i) => (
                    <span
                      key={i}
                      className="inline-flex bg-white text-evren-charcoal text-[14px] font-body font-medium px-[18px] py-[8px] rounded-full border border-evren-light-gray shadow-[0_2px_8px_rgba(26,36,33,0.02)]"
                    >
                      {bonus}
                    </span>
                  ))}
            ...
            <div className="lg:col-span-4 flex flex-col gap-[24px] lg:sticky lg:top-[120px] self-start">
              {/* Callout Box */}
              <div className="bg-evren-navy rounded-[24px] p-[32px] md:p-[40px] relative overflow-hidden group shadow-[0_12px_40px_rgba(26,36,33,0.08)]">
                {/* Decorative blob */}
                <div className="absolute top-0 right-0 w-[200px] h-[200px] bg-[radial-gradient(circle,rgba(136,201,179,0.15)_0%,transparent_70%)] rounded-full blur-xl pointer-events-none -mr-10 -mt-10" />
              ...
              {/* Apply Box */}
              <div className="bg-white border border-evren-light-gray rounded-[24px] p-[32px] md:p-[40px] flex flex-col items-center justify-center text-center shadow-[0_4px_20px_rgba(26,36,33,0.03)]">
